...
export const SCULPT_WORKOUTS: Workout[] = [
  {
    ...
    restTimes: '2–3 min compounds · 60–90 sec accessory',
    duration: '~52 min',
    dayType: 'standard',
    exercises: [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'DB Lateral Raise',           muscle: 'Side Delts', type: 'isolation', cue: '3-sec eccentric · slight lean · side delts are the key to shoulder width and the hourglass illusion' },
      { name: 'Rope Tricep Pushdown',       muscle: 'Triceps',    type: 'isolation', cue: 'Elbows pinned · spread the rope at the bottom · firms the back of the arm' },
  ...
  },
  {
    ...
    restTimes: '90 sec compounds · 45–60 sec isolation/core',
    duration: '~50 min',
    dayType: 'standard',
    exercises: [
...
export function getSculptWeekConfig(week: number, _dayType?: DayType): WeekConfig {
  ...
  if (isDeload) return {
    ...
    note: 'Lighter week — drop the load ~40% and keep movement quality high. You\'ll come back stronger.',
