...
function Confetti() {
  const particles = useMemo(() => {
    const colors = ['var(--orange)','var(--green)','var(--blue)','var(--red)','var(--purple)','#FFD60A','#FF6B6B','#4ECDC4']
    ...
    <div style={{
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center',
        ...
        <div style={{ width:'100%', display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:20,
          ...
          {[
            { Icon:Calendar,  label:'Workouts', value:workoutsCompleted, suffix:'',   color:'var(--blue)' },
            { Icon:BarChart3, label:'Sets Logged', value:totalSets, suffix:'',         color:'var(--green)' },
            { Icon:Zap,       label:'Weeks',   value:12,            suffix:'/12',     color:'var(--orange)' },
            { Icon:TrendingUp,label:'Program', value:100,           suffix:'%',       color:'var(--purple)' },
